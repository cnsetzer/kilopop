...
def make_rosswog_seds(KNE_parameters, min_wave=500.0, max_wave=12000.0):
    """
    ...
    return sed_timeseries(luminosity, min_wave, max_wave)


def sed_timeseries(luminosity, min_wave=500.0, max_wave=12000.0):
    """
    ...
    ti = luminosity[::20, 0]  # times
    Li = luminosity[::20, 1]  # luminosities
    Ti = luminosity[::20, 2]  # Temperatures
    ti_days = ti/day_in_s
