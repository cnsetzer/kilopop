...
from bnspopkne.population import Setzer2022_population as s22p
...
test_dist = s22p(EOS_path="~/Documents/Project1_kNe/kne_modeling/eos_data/",
                 kappa_grid_path="~/Documents/Project1_kNe/kne_modeling/korobkin_heating_rates/outputs/thresholded_uncertainties_20_opacity_df_020221.csv",)

for i in range(12):
    print(getattr(test_dist, f"param{i+1}").shape)
